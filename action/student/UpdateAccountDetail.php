<?php 
	...
	if(isset($_POST["submit"])){
    	...
    	$sql = "UPDATE accountdetail ac SET Address = '$address', DateOfBirth = '$dateofBirth', FullName = '$fullName', Gender = '$gender', PhoneNumber = '$phoneNumber', Identification = '$identification', Email = '$email', PermanentResidence = '$PermanentResidence', ProvinceName = '$ProvinceName', IsPrioritize = '$IsPrioritize', Area = '$Area', GraduatingYear = '$GraduatingYear', HKIGrade10 = '$HKIGrade10', HKIIGrade10 = '$HKIIGrade10', TBGrade10 = '$TBGrade10', HKIGrade11 = '$HKIGrade11', HKIIGrade11='$HKIIGrade11', TBGrade11 = '$TBGrade11', HKIGrade12 = '$HKIGrade12', HKIIGrade12 = '$HKIIGrade12', TBGrade12 = '$TBGrade12', Math = '$Math', Literature = '$Literature', English = '$English', Physics = '$Physics', Chemistry = '$Chemistry', Biology = '$Biology', History = '$History', Geography = '$Geography', GDCD= '$GDCD' WHERE AccountID = '$accountID'";
