...
?>
  ...
  <div class="container">
    <div class="banner">
      <div class="banner-bg" style="background: url('https://www.speedwellsoftware.com/wp-content/uploads/2020/01/lap-top-image-eSystem-report-e1579787837384-1400x425.jpg') no-repeat center center;-webkit-background-size: cover;-moz-background-size: cover;-o-background-size: cover;background-size: cover;"></div>
      <div class="banner-text">
        <div class="text-outer">
          <div class="text-inner">
              <h1>Kỳ thi đánh giá năng lực Đại học Quốc gia Hà Nội</h1>
              <p id="time"></p>
          </div>
        </div>
        <div class="registry-link-container">
          <div class="wrapper">
            <a class="cta" href="studentRegistry.php">
